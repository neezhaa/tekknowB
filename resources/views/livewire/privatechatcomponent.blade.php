    ...
    <div class="flex-1 flex flex-col">
        ...
        <div class="p-4 border-t">
            <div class="flex rounded-lg">
                <input wire:model="newMessage" type="text" placeholder="Type your message..." class="py-[10px] sm:py-3 px-4 block w-full border-gray-200 rounded-s-lg sm:text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500">
